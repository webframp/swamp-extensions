...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Dependency bump: refreshed @webframp/aws/adopt and @webframp/aws/inventory pins; no schema changes",
      upgradeAttributes: (old: Record<string, unknown>) => old,
    },
    {
    ...
    },
    {
      ...
      description: "No schema changes — refreshed dependency manifest pin",
      upgradeAttributes: (old: Record<string, unknown>) => old,
    },
    {
    ...
    },
    {
      ...
      description:
        "Updated @webframp/aws/adopt and @webframp/aws/inventory dependencies; no schema changes",
      upgradeAttributes: (old: Record<string, unknown>) => old,
    },
  ],
