...
**Changed:** Refreshed the `@webframp/aws/cost-explorer`, `@webframp/aws/networking`, and `@webframp/aws/inventory` manifest pins to 2026.09.17.1. No code or behavioral changes.
