...
## Swamp Extension Exception

As a special exception, any extension published to the Swamp Extension Registry
is additionally available under the terms of the AGPL-3.0-or-later license with
the following clarification: using this extension via the `swamp` CLI or its
runtime does not, by itself, cause your project or infrastructure code to be
subject to the AGPL copyleft requirements.
