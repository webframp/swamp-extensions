...
Deno.test({
  ...
  fn: async () => {
    ...
    try {
      ...
      assertEquals(resources[0].specName, "security_monitoring_suppressions");
...
Deno.test({
  ...
  fn: async () => {
    ...
    try {
      ...
      const resources = getWrittenResources();
      assertEquals(resources.length, 1);
      assertEquals(resources[0].specName, "security_monitoring_suppression");
...
Deno.test({
  name:
    "security-suppressions model: list_security_monitoring_suppressions surfaces API errors",
  // sanitizeResources: false — Deno.serve() listener outlives test scope
  sanitizeResources: false,
  fn: async () => {
