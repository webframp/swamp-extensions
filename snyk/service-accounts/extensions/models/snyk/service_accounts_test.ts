...
Deno.test({
  ...
  fn: async () => {
    ...
    try {
      ...
      assertStringIncludes(req0.path, "/groups/test-id-123/service_accounts");
      assertStringIncludes(req0.search, "version=");
      assertEquals(req0.headers["authorization"], "token test-token");

      const resources = getWrittenResources();
      assertEquals(resources.length, 1);
      assertEquals(resources[0].specName, "get_many_group_service_account");
...
Deno.test({
  ...
  fn: async () => {
    ...
    try {
      ...
      const resources = getWrittenResources();
      assertEquals(resources.length, 1);
      assertEquals(resources[0].specName, "group_service_account");
...
Deno.test({
  ...
  fn: async () => {
    ...
    try {
      ...
      const resources = getWrittenResources();
      assertEquals(resources.length, 1);
      assertEquals(resources[0].specName, "one_group_service_account");
