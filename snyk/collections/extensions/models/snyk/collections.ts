...
const GetCollectionsItemSchema = z.object({
  ...
  is_generated: z.boolean().optional().describe(
    "Whether this collection was automatically generated by Snyk",
  ),
  name: z.string().min(1).describe("User-defined name of the collection"),
  ...
  methods: {
    ...
    create_collection: {
      ...
      execute: async (
        ...
        const handle = await context.writeResource("collection", id, {
          ...result,
          fetchedAt: new Date().toISOString(),
          durationMs: Date.now() - startMs,
          collectedBy: EXTENSION_NAME,
