...
// fal.ai codegen. Ported verbatim from scripts/cloudflare-codegen/lib/upgrades.ts
// — this logic is generic over any generated model file and needs no
// fal.ai-specific adaptation.
//
