/**
 * Schema fetcher — downloads and caches the Snyk OpenAPI spec.
 *
 * Fetches from api.snyk.io (pinned to a version date), caches locally
 * in .cache/, and parses the JSON into a typed intermediate representation.
 */
...
const CACHE_FILE = "snyk-openapi.json";
...
/** Fetch or load from cache the Snyk OpenAPI spec */
export async function fetchSchema(
  ...
  console.log(`Fetching Snyk OpenAPI spec from ${SCHEMA_URL}...`);
