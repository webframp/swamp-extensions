  ...
  methods: {
    ...
    update_an_access_policy: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["app_id", "policy_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
    ...
    update_an_mtls_certificate: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["certificate_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
    ...
    update_a_custom_page: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["custom_page_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
    ...
    update_an_access_group: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["group_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
    ...
    update_an_access_identity_provider: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["identity_provider_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
    ...
    create_zero_trust_organization_revoke_all_access_tokens_for_a_user: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["devices"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
        const queryParts: string[] = [];
        const queryKeys = new Set(["devices"]);
        for (const [k, v] of Object.entries(args)) {
    ...
    update_an_access_reusable_policy: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["policy_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
    ...
    update_a_service_token: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["service_token_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
    ...
    update_a_tag: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["tag_name"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
