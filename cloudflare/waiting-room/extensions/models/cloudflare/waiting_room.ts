  ...
  methods: {
    ...
    get_waiting_room_waiting_room_details: {
      ...
      execute: async (
        ...
        const handle = await context.writeResource(
          "waiting_room_waiting_room_details",
          sanitizeInstanceName(String(args.waiting_room_id)),
          result,
        );
    ...
    update_waiting_room: {
      ...
      execute: async (
        ...
        const excludeKeys = new Set(["waiting_room_id"]);
        for (const [k, v] of Object.entries(args)) {
    ...
    update_event: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["event_id", "waiting_room_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
    ...
    patch_waiting_room_rule: {
      ...
      execute: async (
        ...
        const body: Record<string, unknown> = {};
        const excludeKeys = new Set(["rule_id", "waiting_room_id"]);
        for (const [k, v] of Object.entries(args)) {
          if (!excludeKeys.has(k)) body[k] = v;
        }
