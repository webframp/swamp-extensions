...
| [`@webframp/research-collector`](research-collector/) | Collects research intelligence from HN, Lobste.rs, arXiv, SRE Weekly, IFIN Discourse, RedMonk, and The AI Daily Brief; `digest` method produces a compact scored digest with cross-source topic clusters for daily briefing workflows | None (uses fetch) |
